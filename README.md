...
| [✅ To-Do List API](https://github.com/RaykaDev/Python-Projects/tree/main/to-do-list) | API REST com FastAPI para gerenciamento de tarefas, com operações CRUD, validação via Pydantic, autenticação, paginação e ordenação |
