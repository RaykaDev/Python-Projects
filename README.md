...
| [✅ To-Do List API](https://github.com/RaykaDev/Python-Projects/tree/main/to-do-list) | API REST com FastAPI para gerenciamento de tarefas, com persistência em SQLite (via SQLAlchemy), operações CRUD, validação via Pydantic, autenticação, paginação e ordenação |
